            ...
            <Card className="w-full max-w-md bg-slate-800/50 backdrop-blur-md border border-slate-700/50">
              <CardHeader className="space-y-1">
                ...
                <CardDescription className="text-center text-slate-300">
                  Sign up to access all features of the AI Chatbot
                </CardDescription>
              </CardHeader>
              <CardContent>
                {error && (
                ...
                <form onSubmit={handleSignUp} className="space-y-4 mt-4 text-slate-300">
                ...
                <div className="mt-4 text-center">
                  <p className="text-sm text-slate-300">Or sign up with</p>
                  <div className="mt-3">
                    <Button
                      variant="outline"
